...
<section id="main-content">
  ...
  <section class="wrapper site-min-height">
   ...
   <div class="row">
    ...
    <div class="col-md-3"><p>To - <input class="form-control" type="date" id="datepicker" name="date2"></p></div>

    <div class="col-md-3"><br><select name="college" class="form-control col-md-3">
              <option value="aec">ADITYA ENGINEERING COLLEGE</option>
              <option value="acet">ADITYA COLLEGE OF ENGINEERING AND TECHNOLOGY</option>
              <option value="ace">ADITYA COLLEGE OF ENGINEERING</option>
            </select></div>
...
<div class="tab-content" style="border: 1px solid #eee; background: #fff; padding: 10px;">
      <!--  data will write here -->
      <center><h2 class="text-center">Attendance List</h2></center>
      ...
      <div class="table-responsive">
        <table class="table example table-striped table-bordered table-centered table-hover">
          ...
          $date2=$_POST['date2'];
            ...
            $query= "SELECT * FROM `attendance` WHERE date between '".$date1."' AND '".$date2."'"; 
